 ...
 * The Phoenixcoin Developers 2013
 */
...
void BitcoinGUI::createActions()
{
    ...
    signMessageAction->setToolTip(tr("Sign a message to prove you own a Phoenixcoin address"));
    tabGroup->addAction(signMessageAction);

    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setToolTip(tr("Verify a message to ensure it was signed with a specified Phoenixcoin address"));
    ...
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &Phoenixcoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Phoenixcoin window"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Phoenixcoin"
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        ...
        labelMiningIcon->setToolTip(tr("Mining Phoenixcoins at %1 hashes per second").arg(hashrate));
    }
    else
    {
